...
mcuv = circular.movimiento_circular_uniformemente_variado.MovimientoCircularUniformementeVariado(
...
print(
    f"MCUV - Posición a 2s: {pos_mcuv}, Velocidad a 2s: {vel_mcuv}, Aceleración a 2s: {acel_mcuv}"
)
