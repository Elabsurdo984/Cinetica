...
class MovimientoRelativo:
    ...
    def velocidad_relativa(self, velocidad_objeto_a, velocidad_objeto_b):
        ...
        :raises InvalidPhysicsParameterError: Si los vectores de velocidad no tienen la misma dimensión.
        """
    ...
    def direccion_velocidad(self, velocidad_vector):
        ...
        :raises InvalidPhysicsParameterError: Si el vector es de dimensión 0.
        """
